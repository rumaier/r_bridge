...
local function place(model, offset, rotation, minDistance, snapToGround, allowedTerrain)
    ...
    entity = Natives.createObject(model, vec3(0, 0, 0), 0, false)
